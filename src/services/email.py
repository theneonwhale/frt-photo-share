...
from src.conf.messages import EMAIL_CONFIRMATION_REQUEST, PASSWORD_RESET_REQUEST, MSC500_SENDING_EMAIL
...
async def send_email(email: EmailStr, username: str, host: str):
    try:
        ...
        await async_logging_to_file(f'\n500:\t{datetime.now()}\t{MSC500_SENDING_EMAIL}: {err}\t{traceback.extract_stack(None, 2)[1][2]}')
